...
<div>
    ...
    <section>
        <h4><?= __d('setup', 'Add Activity Cycle') ?></h4>
        <div class="row mx-3 mt-2 p-3 form-box">
            ...
            <div class="col-md-12  mt-2">
                ...
                <select id="" size="5" class="form-select option-class dropdown260 " name="activity_id[]" multiple="multiple">
                    <option value=""><?= __d('setup', 'Choose...') ?></option>
					<?php foreach ($activity as $activity_single) { ?>
                    <option value="<?php echo $activity_single['activity_id']; ?>"><?php echo $activity_single['name']; ?></option>
					<?php } ?>
                </select>
            </div>
