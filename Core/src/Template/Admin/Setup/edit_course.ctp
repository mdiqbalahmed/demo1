    ...
    <section>
        ...
        <div class="row mx-3 mt-2 p-3 form-box">
            <div class="col-6 mt-2">
                ...
                <input name="course_name" type="text" class="form-control" id="inputBR" placeholder="Course Name" value="<?php echo $courses[0]['course_name']; ?>" required>
            </div>
            <div class="col-6 mt-2">
                <label for="inputBR" class="form-label"><?= __d('setup', 'Course Code') ?></label>
                <input name="course_code" type="text" class="form-control" id="inputBR" placeholder="Course Code" value="<?php echo $courses[0]['course_code']; ?>" required>
            </div>
            <div class="col-md-6  mt-4">
                ...
                <select id="department_id" class="form-select dropdown260" name="department_id" required>
                    ...
                    <?php foreach ($departments as $department) { ?><option value="<?php echo $department['department_id']; ?>" <?php if ($department['department_id'] == $courses[0]['department_id']) {
                                                                                                                                    echo 'Selected';
                                                                                                                                } ?>>
            ...
            <div class="col-md-3  mt-4">
                ...
                <select id="inputState" class="form-select dropdown260" name="course_type_id" required>
                    <option value=""><?= __d('setup', 'Choose...') ?></option>
                    <?php foreach ($course_types as $course_type) { ?><option value="<?php echo $course_type['course_type_id']; ?>" <?php if ($course_type['course_type_id'] == $courses[0]['course_type_id']) {
                                                                                                                                        echo 'Selected';
                                                                                                                                    } ?>>
            ...
            <div class="col-md-3  mt-4">
                ...
                <select id="inputState" class="form-select dropdown260" name="course_group_id">
                    ...
                    <?php foreach ($scms_groups as $scms_group) { ?>
                        <option value="<?php echo $scms_group->group_id; ?>" <?php if ($scms_group->group_id == $courses[0]['course_group_id']) {
                                                                                    echo 'Selected';
                                                                                } ?>><?php echo $scms_group->group_name; ?></option>
                    <?php } ?>
                </select>
            </div>
