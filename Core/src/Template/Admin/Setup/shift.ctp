...
<body>
	...
	<div class="rows">
		<h3 class="text-center"><?= __d('setup', 'All shifts') ?></h3>
			...
			<tbody>
				...
				?>
					<tr>
						...
						<td>
							<?php echo $this->Html->link('Edit', ['action' => 'editShift', $data->shift_id], ['class' => 'btn action-btn btn-warning']) ?>
							<?php $this->Form->postLink('Delete', ['action' => 'editShift', $data->shift_id], ['class' => 'btn action-btn btn-danger', 'confirm' => 'Are you sure, You want delete this?']) ?>
