    ...
    <section>
        ...
        <div class="row mx-3 mt-2 p-3 pb-4 form-box">
            <div class="col-4 mt-2">
                ...
                <input name="button_title" type="text" class="form-control" placeholder="Enter Button title" required>
            </div>
            <div class="col-4 mt-2">
                <label class="form-label"><?= __d('buttons', 'Button Order') ?></label>
                <input name="button_order" type="text" class="form-control" placeholder="Suggested Order: <?= $buttons+1?>" required>
            </div>
            <div class="col-2 mt-2">
                <label class="form-label"><?= __d('buttons', 'Background Color') ?></label>
                <input name="button_color" type="color" id="backgroundColorInput" class="form-control " style="padding: 0 !important" required>
            </div>
            <div class="col-2 mt-2">
                <label class="form-label"><?= __d('buttons', 'Text Color') ?></label>
                <input name="button_text_color" type="color" id="textColorInput" class="form-control" style="padding: 0 !important" required>
            </div>
            <div class="col-12 mt-2">
                <label class="form-label"><?= __d('buttons', 'Quick Link') ?></label>
                <input name="button_link" type="text" class="form-control" placeholder="Enter Quick Links" required>
            </div>
        </div>
    </section>
