                                ...
                                <div class="col-lg-4">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 row2Field">
                                            <input name="ref_proxy" type="text" class="form-control" value="<?php echo $payments->ref_proxy; ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 row2Field">
                                            <input name="trxId" type="text" class="form-control" value="<?php echo $payments->trxId; ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 row2Field">
                                            <input name="sender" type="text" class="form-control" value="<?php echo $payments->sender; ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-4">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 row2Field">
                                            <input name="receiver" type="text" class="form-control" value="<?php echo $payments->receiver; ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 row2Field">
                                            <input name="amount" type="text" class="form-control" value="<?php echo $payments->amount; ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
