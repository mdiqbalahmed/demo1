...
$this->Form->unlockField('term_percentage');
...
<div>
    ...
    <section class="std_info">
        <h4><?= __d('Result', 'Add Merge Result Template') ?></h4>
        ...
        <h5><?= __d('Result', '##Terms') ?></h5>

        <div class="term" style="margin-left: 15px;" id="">
            <div class="col-md-12 mx-3  p-3" id="single_row">
                <div class="row">
                    <div class="col-md-1"> </div>
                    <div class="col-md-2">
                        <label for="my-input" class="form-label"><?= __d('Result', 'term 1:') ?></label>
                    </div>
                    <div class="col-md-4">
                        <select id="term_1"  style="width:100%;" class="form-select option-class dropdown260" name="term[]" required >
                    ...
                    <div class="col-md-2">
                        <input name="term_percentage[]" type="number" class="form-control" id="inputSId" placeholder="Persentage" required>
                    </div>
                    <div class="col-md-1">
            ...
            <div class="col-md-12 mx-3  p-3" id="single_row">
                <div class="row">
                    <div class="col-md-1"> </div>
                    <div class="col-md-2">
                        <label for="my-input" class="form-label"><?= __d('Result', 'term 2:') ?></label>
                    </div>
                    <div class="col-md-4">
                        <select id="term_1"  style="width:100%;" class="form-select option-class dropdown260" name="term[]" required >
                            <option value=""><?= __d('students', '-- Choose --') ?></option>
            ...
            <div class="col-md-12 mx-3  p-3" id="single_row">
                <div class="row">
                    <div class="col-md-1"> </div>
                    <div class="col-md-2">
                        <label for="my-input" class="form-label"><?= __d('Result', 'term 3:') ?></label>
                    </div>
                    <div class="col-md-4">
                        <select id="term_3"  style="width:100%;" class="form-select option-class dropdown260" name="term[]" required >
                            <option value=""><?= __d('students', '-- Choose --') ?></option>
                             <?php foreach ($terms as $id => $term) {  ?>
                            <option value="<?php echo $term->term_id; ?>"><?php echo $term->term_name; ?></option>
                            <?php }?>
...
<script type='text/javascript'>
    $(document).ready(function () {
        ...
        $('.term').on('click', '#delete', function (eq) {
            $(this).closest('#single_row').remove();
        });
    });
