                   ...
                   <?php foreach ($grades as $grade) { ?>
                    <div class="old">
                        ...
                        <div class="row mt-2" id="single_row">
                            ...
                            <div class="col-md-2">
                                <input id=""  name="point[<?php echo $grade['grade_id']; ?>]" type="number" max="5" min="0" class="form-control" value="<?php echo $grade['point']; ?>" required>
                            </div>
                            <div class="col-md-2">
                                <input id=""  name="percentage_down[<?php echo $grade['grade_id']; ?>]" type="number" max="100" min="0" class="form-control" value="<?php echo $grade['percentage_down']; ?>" required>
                            </div>
                            <div class="col-md-2">
                                <input id=""  name="percentage_top[<?php echo $grade['grade_id']; ?>]" type="number" max="100" min="0" class="form-control" value="<?php echo $grade['percentage_top']; ?>" required>
                            </div>
                            <div class="col-md-1">
