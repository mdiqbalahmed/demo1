...
<div>
    <?= $this->Form->create(); ?>
    <section>
        <h4><?= __d('accounts', 'Add Transaction(Credit)') ?></h4>
        <div class="row mx-3 mt-2 p-3 form-box">
            ...
            <input type="hidden" name="transaction_type" class="form-control" value="Credit">
            <div class="col-md-6 col-12 mt-2">
            ...
            <div class="col-md-6 col-12 mt-1">
                ...
                <div class=" mystyle_hidden" id="staff">
                    ...
                    <?php foreach ($employees  as $employee) { ?>
                        <option value="<?= $employee->employee_id ?>"><?= h($employee->name) ?></option>
                    <?php } ?>
                    </select>
                </div>
            </div>
            <div class="col-md-6 col-12 mt-1">
                ...
                <select id="session_id" class="form-select option-class" name="session_id" required>
                    ...
                    <option value="<?= $session->session_id; ?>"  <?php if($session->active){echo "selected";} ?>><?= $session->session_name; ?></option>
                    <?php } ?>
                </select>
            </div>
            <div class="col-md-6 col-12 mt-1">
