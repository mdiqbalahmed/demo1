...
<body>
    ...
    <div class="rows">
        ...
        <span
            class="text-right float-right mb-3"><?= $this->Html->link('Add Purpose', ['action' => 'addPurpose'], ['class' => 'btn btn-info']) ?></span>
        ...
        <table class="table table-bordered table-striped">
            <thead class="thead-dark">
                <tr>
                    ...
                    <th><?= __d('accounts', 'Report Type') ?></th>
