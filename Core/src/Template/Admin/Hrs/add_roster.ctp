        ...
        <div class="row mt-2 p-3">
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <input name="roster_name" type="text" class="form-control" id="inputSId" placeholder="Roster Name" required>
                    </div>
                </div>
            </div>
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input name="start_date" type="date" class="form-control" id="inputSId">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input name="end_date" type="date" class="form-control" id="inputSId">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-1 mt-1">
                <input type="checkbox" class="" id="" name="employee_id[]" value="<?php echo $employee['employee_id'];  ?>">
            </div>
