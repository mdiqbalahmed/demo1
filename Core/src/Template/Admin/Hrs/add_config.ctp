        ...
        <div class="row mx-3 mt-2 p-3 form-box">
            <div class="col-md-12">
                <div class="row">
					...
					<?php foreach ($hr_configs as $hr_config) { ?>
                            <option value="<?php echo $hr_config['config_key']; ?>"><?php echo $hr_config['config_name']; ?></option>
					<?php } ?>
                        </select>
            ...
            <div class="col-md-12  mt-3">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <input name="config_action_name" type="text" class="form-control" id="inputSId" placeholder="Action Name" required>
                    </div>
                </div>
            </div>
