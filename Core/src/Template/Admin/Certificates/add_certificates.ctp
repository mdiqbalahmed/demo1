...
<div>
    <?php if (isset($tags)) {
        ...
        <h3 class="text-center mt-2 mb-5"><?= __d('Certificates', 'Fill up the form to proceed') ?></h3>
        ...
        <div class="row">
            ...
            foreach ($tags as $key => $tag) { ?>
                ...
                <div class="col-lg-4 mt-2">
                    <input name="<?php echo $tag['tag'] ?>[value]" type="text" class="form-control" value="<?php if (isset($tag['tag_value'])) {
                                                                                                                echo $tag['tag_value'];
                                                                                                            } ?>" required>
                    <input name="<?php echo $tag['tag'] ?>[width]" type="hidden" class="form-control" value="<?php if (isset($tag['width'])) {
                                                                                                                    echo $tag['width'];
                                                                                                                } ?>">
                </div>
            <?php } ?>
