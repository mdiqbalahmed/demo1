...
<body>
	<div class="p-5" style="background-color: #f2f2f2; padding: 10px;">
			...
			<div class="col-md-8">
				<div class="row">
					...
					<div class="col-lg-9 mt-2">
						<input name="tag" type="text" class="form-control" placeholder="Enter Tag">
					</div>
					<div class="col-lg-3 mt-2">
						<p class="label-font"><?= __d('Certificates', 'Tag Description') ?></p>
					</div>
					<div class="col-lg-9 mt-3">
						<textarea name="tag_description" class="form-control" rows="2" placeholder="Enter Tag Description"></textarea>
					</div>
				</div>
			</div>
			<div class="col-md-2"></div>
		...
		<div class="text-right mt-5">
			<button type="submit" class="btn btn-info"><?= __d('Certificates', 'Add Tag') ?></button>
