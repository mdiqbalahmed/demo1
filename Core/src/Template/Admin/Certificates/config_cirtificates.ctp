...
<body>
	...
	<div class="rows">
		<h3 class="text-center"><?= __d('Certificates', 'All Configurations') ?></h3>

		<span class="text-right float-right mb-3"><?php echo $this->Html->link('Add Configuration', ['action' => 'addConfig'], ['class' => 'btn btn-info']) ?></span>
		...
		<table class="table table-bordered table-striped">
			<thead class="thead-dark">
				<tr>
					...
					<th><?= __d('Certificates', 'Configuration Name') ?></th>
			...
			<tbody>
				...
				?>
					<tr>
						...
						<td><?php echo $config['certificate_title'] ?></td>
						<td>
							<?php echo $this->Html->link('Edit', ['action' => 'editConfig', $config['config_id']], ['class' => 'btn action-btn btn-warning']) ?>
