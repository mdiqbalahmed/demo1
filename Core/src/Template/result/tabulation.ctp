            ...
            <div class="tabulationTop">
                ...
                <div class="overlays">
                    <div class="text-center">
                        ...
                        <p class="title_exam_2">
                            <?php
                                $sectionName = $students[0]['section_name'];
                                $levelName = strtoupper($students[0]['level_name']);
                                $sessionName = $students[0]['session_name'];
                        
                                echo 'CLASS: ' . $levelName . '(' . $sectionName . ') - TABULATION SHEET ' . $sessionName;
                            ?>
                        </p>
                    </div>
                </div>
