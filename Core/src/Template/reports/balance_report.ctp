    ...
    <div style="background-color: rgba(0, 0, 0, 0.2); padding: 10px; margin-top: 10px; overflow-x:auto;">
        <table class="table table-bordered table-striped">
            <p style="position: relative;">
                ...
                <span style="position: absolute; right: 0;">Report Time:
                    <?php echo $date = date('d-m-Y h:i A'); ?></span>
            </p>
            ...
            <tbody>
                ...
                <td style="font-size: 16px; text-align: center;"> <?php echo number_format($previous_balance, 2); ?>
                </td>
                <?php
